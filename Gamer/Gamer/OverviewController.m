...
- (NSString *)formattedHTMLWithBody:(NSString *)body font:(UIFont *)font textColor:(UIColor *)textColor{
	...
	NSString *HTML = [NSString stringWithFormat:@"<html>\n"
					  ...
					  "figcaption {font-size: 12; width: %@px; margin-left: -40px; margin-right: 15px; text-align: center;}\n"
					  "table {font-size: 12; text-align: center; border-collapse: collapse;}\n"
					  "th {background-color: #161616;}\n"
					  "td {background-color: #1B1B1B; border-top: 8px red;}\n"
