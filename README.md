...
For features, bugs or suggestions, please open a new [issue](https://github.com/caiomello/gamer/issues) with the appropriate labels, or send an email to [gamer.app@icloud.com](mailto:gamer.app@icloud.com).
